...
// Class-based background control: blur on Our Works + Showreel; hide bg on services/contact
(function(){
  ...
  if (focusTargets.length){
    const ioBlur = new IntersectionObserver((ents)=>{
      const any = ents.some(ent => ent.isIntersecting && ent.intersectionRatio > 0.5);
